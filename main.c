...
void show_book_information();//显示图书信息菜单
void borrow_menu();//显示借阅信息菜单
void login_menu();//显示登录菜单

void administrator ();//实现管理员功能
void student ();//实现学生功能
void show_administrator ();//管理员界面
void show_student ();//学生界面

void main_menu();// 主菜单功能
void tsmain();//图书菜单功能
...
void show_book_information() //图书馆信息菜单
{
system ("cls");
printf("****************************************************");
printf("\n 1.增加图书\n\n");
